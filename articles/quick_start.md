...
BayesRTMB uses RTMB / TMB internally. On Windows, Rtools is required to
compile these dependencies.

You can check whether Rtools is available with the following code.
...
setup is ready. If Rtools is not found, install the Rtools version that
matches your R version, then restart R or RStudio.
