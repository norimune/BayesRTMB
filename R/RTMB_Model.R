...
RTMB_Model <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param df_vars Character vector; parameter names to count for degrees of freedom calculation (e.g. c("beta", "alpha")). If specified, DF = n_obs - (total number of parameters in df_vars). Default is NULL.
    ...
    optimize = function(laplace = TRUE, init = NULL, num_estimate = 1, control = list(),
                        ...
                        se = TRUE, auto_df = FALSE, df_t = Inf, n_obs = NULL,
                        df_vars = NULL) {
      ...
      if (!is.null(n_obs) && is.character(n_obs) && n_obs == "auto") {
        ...
        if (!is.null(n_obs) && !is.na(n_obs)) {
          ...
          cat("Warning: Automatic n_obs detection failed. BIC calculation may be affected.\n")
          n_obs <- NULL
        }
      }
