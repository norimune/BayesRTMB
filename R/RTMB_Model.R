...
RTMB_Model <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(data, par_list, log_prob,
                          ...
                          init = NULL, view = NULL, code = NULL, gr_test = FALSE) {
      self$data <- data
      ...
      test_ad <- self$build_ad_obj(init = init_vec, laplace = FALSE, jacobian_target = "none")
      if (isTRUE(gr_test)) {
    ...
    #'   was used when creating the model. Default is `"auto"`.
