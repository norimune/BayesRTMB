...
These functions allow you to specify models with a syntax similar to standard R functions like `lm()` and `lme4::glmer()`, while fully utilizing the powerful estimation features of BayesRTMB (MCMC, MAP, ADVI).
