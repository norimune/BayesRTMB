...
Also, using `rtmb_ttest()`, a Bayesian t-test can be performed easily. By simply specifying the parameters to fix in the `fixed` argument of the `bayes_factor()` method (as a list), the estimation of the null model and the calculation of the Bayes factor are done automatically.
