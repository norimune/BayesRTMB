...
You can start from wrapper functions such as
...
or write your own model with
[`rtmb_code()`](https://norimune.github.io/BayesRTMB/reference/rtmb_code.md).
The same model object can then be used for MCMC, MAP estimation,
variational inference, and frequency-oriented classical analyses where
supported.
...
- **Classical analyses from wrappers**: Use `$classic()` for
  frequency-oriented outputs, including
  [`AIC()`](https://rdrr.io/r/stats/AIC.html),
  [`BIC()`](https://rdrr.io/r/stats/AIC.html), and
  [`anova()`](https://rdrr.io/r/stats/anova.html) for supported fits.
